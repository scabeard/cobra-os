...
# Source: thc-tips-tricks-hacks-cheat-sheet-master/tools/mkegg.sh (THC, hackerschoice)
# Why vendored: the cobra-ops `egg` wizard must run a LOCAL copy of this
# script. COBRA prime directive: no remote sourcing of scripts, ever. Do NOT
# add download fallbacks here — upstream provenance stays in this header.
# COBRA edits vs upstream: SC2124 shellcheck fix (${*: -1} below) — the
