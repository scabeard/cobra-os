#! /usr/bin/env bash
#
# VENDORED FOR COBRA OS (2026-08-13)
# Source: thc-tips-tricks-hacks-cheat-sheet-master/tools/ghostip.sh (THC, hackerschoice)
# Why vendored: cobrashell's ghostip() must source a LOCAL copy of this script.
# COBRA prime directive: no remote sourcing of scripts, ever. Do NOT add
# download fallbacks here — upstream upstream provenance stays in this header
# and in shell/cobrashell.sh.
