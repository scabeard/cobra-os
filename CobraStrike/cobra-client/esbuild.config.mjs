/**
 * Bundles cobra-client into a single self-contained ESM file (dist/cobra.js).
 * This is the artifact served from the website and fetched by install.sh.
